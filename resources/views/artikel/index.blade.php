                ...
                <div class="container mt-5">
                  <div class="row mb-4">
                    <div class="col text-center">
                      <div class="dashboard-title">HALAMAN DATA ARTIKEL</div>
                    </div>
                  </div>
                  
                
                        <div class="container">
                            <h2 class="mb-4">Data ARTIKEL</h2>
                                      ...
                                      <table class="table">
                                          ...
                                          <tbody>
                                            <tr>
                                              ...
                                              <td>{{ $data->isi }}</td>
                                              <td><img src="{{ asset('images/artikel/' . $data->foto) }}" alt="Foto" class="img-fluid"></td>


                      
            
                                              <td class="text-center col-4">
                                                <form action="{{ route('artikel.destroy', $data) }}" method="POST" onsubmit="return confirm('Anda ingin menghapus data tersebut?');">
                                                  <a href="{{ route('artikel.edit', $data) }}" class="btn btn-sm btn-primary">Edit</a>
                                                  @csrf
                                                  @method('DELETE')
